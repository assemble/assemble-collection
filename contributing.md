# Contributing to assemble-collection

First and foremost, thank you! We appreciate that you want to contribute to assemble-collection, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for assemble-collection**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for assemble-collection:

- star the [project](https://github.com/assemble/assemble-collection)
- tweet your support for assemble-collection
...
- **version**: please note the version of assemble-collection are you using
...
[so]: http://stackoverflow.com/questions/tagged/assemble-collection